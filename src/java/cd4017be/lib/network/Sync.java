 ...
 * For use in classes implementing {@link TagSynchronized}.
...
public @interface Sync {
	...
	public enum Type {
		...
		static byte readI8(Tag nbt) {return nbt instanceof NumberNBT ? ((NumberNBT)nbt).getAsByte() : 0;}
		static short readI16(Tag nbt) {return nbt instanceof NumberNBT ? ((NumberNBT)nbt).getAsShort() : 0;}
		static int readI32(Tag nbt) {return nbt instanceof NumberNBT ? ((NumberNBT)nbt).getAsInt() : 0;}
		static long readI64(Tag nbt) {return nbt instanceof NumberNBT ? ((NumberNBT)nbt).getAsLong() : 0L;}
		static float readF32(Tag nbt) {return nbt instanceof NumberNBT ? ((NumberNBT)nbt).getAsFloat() : 0F;}
		static double readF64(Tag nbt) {return nbt instanceof NumberNBT ? ((NumberNBT)nbt).getAsDouble() : 0D;}
		...
		static Tag writeI1(boolean val) {return ByteNBT.valueOf(val);}
		static Tag writeI8(byte val) {return ByteNBT.valueOf(val);}
		static Tag writeI16(short val) {return ShortNBT.valueOf(val);}
		static Tag writeI32(int val) {return IntNBT.valueOf(val);}
		static Tag writeI64(long val) {return LongTag.valueOf(val);}
		static Tag writeF32(float val) {return FloatNBT.valueOf(val);}
		static Tag writeF64(double val) {return DoubleNBT.valueOf(val);}
